...
@conversion_method(type_from=gd.PhaseSpacePosition, type_to=gcx.PhaseSpacePosition)  # type: ignore[arg-type]
...
@gcx.PhaseSpacePosition.from_.dispatch  # type: ignore[attr-defined,misc]
def from_(
...
@conversion_method(type_from=gcx.PhaseSpacePosition, type_to=gd.PhaseSpacePosition)  # type: ignore[arg-type]
