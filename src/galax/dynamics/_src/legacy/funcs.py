...
def evaluate_orbit(
    ...
    *,
    ...
    >>> potential = gp.KeplerPotential(m_tot=u.Q(1e12, "Msun"), units="galactic")
    ...
    >>> orbit = gd.evaluate_orbit(potential, w0, u.Q(0.5, "Gyr"))
    >>> orbit
    ...
    ...                              p=u.Q([0, 200, 0], "km/s"),
    ...                              t=u.Q(0, "Myr"))
    >>> ts = u.Q(jnp.linspace(0.3, 1, 8), "Gyr")
    >>> orbit = gd.evaluate_orbit(potential, w0, ts)
