...
def potential(*args: Any, **kwargs: Any) -> Any:
    ...
    >>> w = gc.PhaseSpaceCoordinate(q=u.Q([1, 2, 3], "kpc"),
    ...                             p=u.Q([4, 5, 6], "km/s"),
    ...                             t=u.Q(0, "Gyr"))
    ...
    >>> w = gc.PhaseSpaceCoordinate(q=u.Q([[1, 2, 3], [4, 5, 6]], "kpc"),
    ...                             p=u.Q([[4, 5, 6], [7, 8, 9]], "km/s"),
    ...                             t=u.Q([0, 1], "Gyr"))
    >>> pot.potential(w)
    Q([-1.20227527, -0.5126519 ], 'kpc2 / Myr2')
    ...
    >>> pot.potential(q, t)
    Q([-0.55372734, -0.46647294], 'kpc2 / Myr2')
...
def gradient(*args: Any, **kwargs: Any) -> Any:
    ...
    >>> wt = gc.PhaseSpaceCoordinate(q=u.Q([[1, 2, 3], [4, 5, 6]], "kpc"),
    ...                              p=u.Q([[4, 5, 6], [7, 8, 9]], "km/s"),
    ...                              t=u.Q([0, 1], "Gyr"))
    ...
    >>> t = u.Q(0, "Gyr")
    >>> pot.gradient(xyz, t)
    Q([0.08587681, 0.17175361, 0.25763042], 'kpc / Myr2')
...
def laplacian(*args: Any, **kwargs: Any) -> u.Quantity["1/s^2"] | Array:
    ...
    >>> w = cx.FourVector(q=u.Q([1, 2, 3], "kpc"), t=u.Q(0, "Gyr"))
    >>> pot.laplacian(w).round(4)
    Q(0., '1 / Myr2')
...
def hessian(*args: Any, **kwargs: Any) -> Any:
    ...
    >>> pot.hessian(w)
    Q([[ 0.06747463, -0.03680435, -0.05520652],
    ...
    Q([[[ 0.06747463, -0.03680435, -0.05520652],
       ...
       [[ 0.00250749, -0.00518791, -0.00622549],
        ...
        [-0.00622549, -0.00778186, -0.00268042]]], '1 / Myr2')
    ...
    >>> q = apyc.CartesianRepresentation(x=[1, 2], y=[4, 5], z=[7, 8], unit="kpc")
    >>> pot.hessian(q, t)
    Q([[[ 0.00800845, -0.00152542, -0.00266948],
       ...
       [[ 0.00436863, -0.00161801, -0.00258882],
        ...
        [-0.00258882, -0.00647205, -0.00533944]]], '1 / Myr2')
...
def tidal_tensor(*args: Any, **kwargs: Any) -> gt.BBtQuSz33 | gt.BBtSz33:
    ...
    >>> q = cx.CartesianPos3D.from_(u.Q([1, 2, 3], "kpc"))
    >>> t = u.Q(0, "Gyr")
    >>> pot.tidal_tensor(q, t=t)
    Q([[ 0.06747463, -0.03680435, -0.05520652],
       [-0.03680435,  0.01226812, -0.11041304],
...
def local_circular_velocity(*args: Any, **kwargs: Any) -> gt.BBtQuSz0:
    ...
    Q(0.16894332, 'kpc / Myr')

    >>> x = cx.CartesianPos3D.from_([8.0, 0.0, 0.0], "kpc")
    >>> gp.local_circular_velocity(pot, x, t=u.Q(0.0, "Gyr"))
    Q(0.16894332, 'kpc / Myr')
...
def dpotential_dr(*args: Any, **kwargs: Any) -> gt.BtQuSz0:
    ...
    >>> pot.dpotential_dr(w)
    Q([0.32132158, 0.05842211], 'kpc / Myr2')
...
def d2potential_dr2(*args: Any, **kwargs: Any) -> gt.BBtQorVSz0:
    ...
    >>> pot.d2potential_dr2(w)
    Q([-0.17175361, -0.01331563], '1 / Myr2')
    ...
    >>> w = cx.FourVector(q=u.Q([1, 2, 3], "kpc"), t=t)
    >>> pot.d2potential_dr2(w)
    Q(-0.17175361, '1 / Myr2')
...
def spherical_mass_enclosed(*args: Any, **kwargs: Any) -> gt.BtQuSz0:
    ...
    >>> w = gc.PhaseSpaceCoordinate(q=u.Q([8, 0, 0], "kpc"),
    ...                             p=u.Q([0, 0, 0], "km/s"),
    ...                             t=u.Q(0, "Gyr"))
    >>> gp.spherical_mass_enclosed(pot, w).uconvert("Msun")
    Q(9.99105233e+10, 'solMass')

    - `galax.coordinates.PhaseSpacePosition`:

    >>> w = gc.PhaseSpacePosition(q=u.Q([8, 0, 0], "kpc"),
    ...                           p=u.Q([0, 0, 0], "km/s"))
    >>> t = u.Q(0, "Gyr")
    ...
    >>> vec4 = cx.vecs.FourVector(q=u.Q([8, 0, 0], "kpc"), t=t)
    ...
    Q([9.99105233e+10, 1.10435505e+11], 'solMass')
    ...
    >>> xs = u.Q([[8, 0, 0], [10, 0, 0]], "kpc")
    >>> ts = u.Q([0, 1], "Gyr")
    >>> gp.spherical_mass_enclosed(pot, xs, ts).uconvert("Msun")
    Q([9.99105233e+10, 1.20586103e+11], 'solMass')
