...
class Potential:
    ...
    def gen_stream_final(self, ts, prog_w0, Msat):
        ...
        def scan_fun(carry, particle_idx):
            ...
            #####w_particle_close = self.orbit_integrator_run(curr_particle_w0_close,minval,maxval,None)[0]
            #####w_particle_far = self.orbit_integrator_run(curr_particle_w0_far,minval,maxval,None)[0]
