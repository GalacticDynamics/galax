...
class TestVogelsberger08TriaxialNFWPotential(
    ...
    def test_potential(
        self, pot: Vogelsberger08TriaxialNFWPotential, x: gt.QSz3
    ) -> None:
    ...
    def test_density(self, pot: Vogelsberger08TriaxialNFWPotential, x: gt.QSz3) -> None:
        expect = u.Quantity(1.10157433e09, "solMass / kpc3")
        assert jnp.isclose(
            pot.density(x, t=0), expect, atol=u.Quantity(1e-8, expect.unit)
        )

    def test_hessian(self, pot: Vogelsberger08TriaxialNFWPotential, x: gt.QSz3) -> None:
        expect = u.Quantity(
            [
