...
class TestMilkyWayPotential(AbstractCompositePotential_Test):
    ...
    def test_potential(self, pot: gp.MilkyWayPotential, x: gt.QSz3) -> None:
    ...
    def test_gradient(self, pot: gp.MilkyWayPotential, x: gt.QSz3) -> None:
    ...
    def test_density(self, pot: gp.MilkyWayPotential, x: gt.QSz3) -> None:
    ...
    def test_hessian(self, pot: gp.MilkyWayPotential, x: gt.QSz3) -> None:
